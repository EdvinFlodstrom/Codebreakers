...
public class MeleePenguinMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if(movingLeft == false)
            {
                penguin.transform.localScale = new Vector3((float)-0.5, penguin.transform.localScale.y, penguin.transform.localScale.z);
            }
            else penguin.transform.localScale = new Vector3((float)0.5, penguin.transform.localScale.y, penguin.transform.localScale.z);
        }
    }
